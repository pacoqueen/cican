...
class Contadores(Ventana):
    ...
    def cambiar_contador(self, boton):
        ...
        if iter != None:
            ...
            utils.ui.dialogo_info('ERROR','Seleccione contador a modificar', padre = self.wids['ventana'])
    ...
    def eliminar_contador(self,widget):
        ...
        try:    
            ...
            utils.ui.dialogo_info('ERROR','No se ha podido eliminar el contador. Probablemente existan clientes con este contador.')
        self.rellenar_tabla()
    ...
    def modificar_contador(self, widget):
        ...
        if prefijo != None:
            ...
            try:    
                ...
                utils.ui.dialogo_info('ERROR','No se ha podido modificar el contador.')
            self.rellenar_tabla()
    ...
    def crear_nuevo_contador(self, widget):
        ...
        """
        prefijo = utils.ui.dialogo_entrada('Introduzca el prefijo del nuevo contador')
        if prefijo != None:
            sufijo = utils.ui.dialogo_entrada('Introduzca el sufijo del nuevo contador')
            if sufijo != None:
