...
class Colors(object):
    """
     # PyUML: Do not remove this line! # XMI_ID:_XW0t4e5DEd-QvZvwvxUy6Q
    """
...
class Graphics(object):
    ...
    # PyUML: Do not remove this line! # XMI_ID:_XW3KJe5DEd-QvZvwvxUy6Q
    """
    ...
    _stroke_preserve = staticmethod(_stroke_preserve)
    ...
    _move_to = staticmethod(_move_to)
    ...
    _line_to = staticmethod(_line_to)
    ...
    _rel_line_to = staticmethod(_rel_line_to)
    ...
    _curve_to = staticmethod(_curve_to)
    ...
    _arc_negative = staticmethod(_arc_negative)
    ...
    _show_layout = staticmethod(_show_layout)
...
class Area(gtk.DrawingArea):
    ...
    """ animation bits """
    def __interpolate(self):
        self.__animating = self.tweener.has_tweens()
