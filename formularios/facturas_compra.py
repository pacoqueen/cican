...
@author: bogado
    ...
    Facturas de compra a proveedores para la gestión de cobro.

'''

# TODO: Falta columna de totales de línea y cuadro resumen de pendiente de pago.
...
class FacturasCompra(VentanaGenerica):
...
def main():
    ...
    ventana = FacturasCompra(*params, **opt_params)
