...
# añade alguna cadena. Instala gtranslator si quieres llevar una vida mejor-
...
try:
    ...
    from utils import insertar_boton_copiar_al_portapapeles
except ImportError:
    try:
        from utils.ui import dialogo_entrada as fdialogo
        from utils.ui import insertar_boton_copiar_al_portapapeles
    except ImportError:
        sys.path.append("..")
        from utils.ui import dialogo_entrada as fdialogo
        from utils.ui import insertar_boton_copiar_al_portapapeles
...
def _info(exctyp, value, tb):
    ...
    while True:
        ...
        if resp == 3:
            ...
            try:
                s.sendmail(email, (devs_to,), message) 
            except NameError:
            ...
            insertar_boton_copiar_al_portapapeles(details, 
